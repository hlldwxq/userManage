...
function(a) {
    ...
    a.FE.MODULES.clean = function(b) {
        ...
        function e(a) {
            ...
            a = a.replace(/<iframe\b[^<]*(?:(?!<\/iframe>)<[^<]*)*<\/iframe>/gi,
            function(a) {
                return K.push(a),
        ...
        function f(a) {
            ...
            a = a.replace(/\[FROALA\.EDITOR\.IFRAME ([\d]*)\]/gi,
            function(a, c) {
        ...
        function r(c, d, e, f) {
            ...
            J = b.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + b.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null,
            c = k(c, p, !0)
        }
        function s() {
    ...
    a.FE.UNICODE_NBSP = String.fromCharCode(160), a.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], a.FE.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], a.extend(a.FE.DEFAULTS, {
        ...
        function i(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild, j = !1; i;) {
                    ...
                    f.appendChild(i.cloneNode(!0));
                    else if ("BR" == i.tagName) null == g ? (g = b.doc.createElement(e), d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0), g.appendChild(i.cloneNode(!0)), f.appendChild(g), j = !0) : h === !1 && (g.appendChild(b.doc.createElement("br")), d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0)),
                    g = null;
                    else {
                        var l = i.textContent;
        ...
        function v() {
            ...
            o(),
            b.opts.htmlUntouched || (b.spaces.normalize(null, !0), b.html.fillEmptyBlocks(), b.clean.quotes(), b.clean.lists(), b.clean.tables(), b.clean.toHTML5(), b.html.cleanBRs()),
            b.selection.restore(),
            w(),
            ...
            if (f = d ? c: b.clean.html(c), f = f.replace(/\r|\n/g, " "), c.indexOf('class="fr-marker"') < 0 && (f = I(f)), b.core.isEmpty() && !b.opts.keepFormatOnDelete && H(f)) b.el.innerHTML = f;
                ...
                if (g) {
                    ...
                    if ((H(f) || e) && (h = b.node.deepestParent(g) || i && "LI" == i.tagName)) {
                        if (i && "LI" == i.tagName && (f = K(f)), g = b.markers.split(), !g) return ! 1;
                        g.outerHTML = f
                    } else g.outerHTML = f
    ...
    a.FE.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], a.FE.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], a.FE.MODULES.cursor = function(b) {
        ...
        function k() {
            ...
            b.opts.htmlUntouched || (b.html.cleanEmptyTags(), b.clean.quotes(), b.clean.lists()),
        ...
        function r(c, d, g) {
            ...
            h && b.node.isElement(c.parentNode) ? a(c).replaceWith("<" + h + ">" + a.FE.MARKERS + "<br></" + h + ">") : a(c).replaceWith("<br>" + a.FE.MARKERS);
                ...
                if (b.node.isBlock(i)) if (d) a(c).remove(),
            ...
            if (b.selection.isCollapsed()) {
                ...
                if (b.node.openTagString(h.get(0)) == '<span style="' + c + ": " + h.css(c) + ';">') {
                    if (b.node.isEmpty(h.get(0))) h.replaceWith('<span style="' + c + ": " + d + ';">' + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + "</span>");
                        ...
                        i(f, "span", j, !0),
                        f = b.$el.find(".fr-marker"),
                        f.replaceWith('<span style="' + c + ": " + d + ';">' + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + "</span>")
                    }
                    b.html.cleanEmptyTags()
    ...
    a.extend(a.FE.DEFAULTS, {
        ...
        function g() {
            ...
            b.events.disableBlur(),
            r = null,
            t ? (t.html(""), b.browser.edge && b.opts.iframe && b.$el.append(t)) : (t = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%;" tabIndex="-1"></div>'), b.browser.safari ? (t.css("top", b.$sc.scrollTop()), b.$el.after(t)) : b.browser.edge && b.opts.iframe ? b.$el.append(t) : b.$box.after(t), b.events.on("destroy",
            function() {
                t.remove()
            })),
            t.focus(),
        ...
        function j() {
            ...
            b.keys.forceUndo(),
            u = b.snapshot.get(),
            null === r && (r = t.get(0).innerHTML, b.selection.restore(), b.events.enableBlur());
            ...
            (!a || a && b.events.trigger("paste.wordPaste", [r]) !== !1) && k(r, a)
        }
        function k(c, d, e) {
            var f, g = null,
            j = null;
            ...
            if (c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"), k = !0), !d) {
                ...
                b.opts.htmlAllowedStyleProps = m,
            ...
            } ! d || b.wordPaste && e || (c = c.replace(/^\n*/g, "").replace(/^ /g, ""), 0 === c.indexOf("<colgroup>") && (c = "<table>" + c + "</table>"), c = h(c), c = n(c)),
    ...
    a.FE.RegisterCommand("fullscreen", {
        ...
        function d() {
            ...
            d = 0; d < a.FE.DEFAULTS.helpSets.length; d++) {
                ...
                f = "<table>";
                f += "<thead><tr><th>" + e.title + "</th></tr></thead>",
                f += "<tbody>";
    ...
    a.FroalaEditor.DefineIcon("help", {
        ...
        function ja(a) {
            Da && (ma() || a === !0) && (b.toolbar.enable(), Ea.removeClass("fr-active"), b.popups.hide("image.edit"), Da = null, la())
        }
        function ka() {
            Ta = !0
        }
        ...
        function Aa(a, c, d) {
            ...
            "object" == typeof c[a] ? (Da.removeAttr("style"), Da.css(c[a].style)) : Da.toggleClass(a),
            w(Da)
        }
        function Ba() {
    ...
    a.FE.PLUGINS.lineBreaker = function(b) {
        ...
        function g(a, c, d) {
            for (var e = d,
            g = null; e <= b.opts.lineBreakerOffset && !g;) g = f(a, c - e),
            g || (g = f(a, c + e)),
            e += d;
            return g
        }
        function h(a, c, d) {
            for (var e = null; ! e && a > b.$box.offset().left && a < b.$box.offset().left + b.$box.outerWidth();) e = f(a, c),
            e || (e = g(a, c, 5)),
        ...
        function o() {
            ...
            !0),
            b.events.$on(q, "mousemove",
            function(a) {
                a.stopPropagation()
            },
            !0),
            b.events.$on(q, "mousedown", "a",
            function(a) {
                a.stopPropagation()
            },
            !0),
    ...
    a.FE.PLUGINS.link = function(b) {
        ...
        function r(f, g, h) {
            ...
            if (b.opts.linkConvertEmailAddress) {
                var k = a.FE.MAIL_REGEX;
                k.test(f) && !/^mailto:.*/i.test(f) && (f = "mailto:" + f)
            }
            var l = /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i;
            if ("" === b.opts.linkAutoPrefix || new RegExp("^(" + a.FE.LinkProtocols.join("|") + "):.", "i").test(f) || /^data:image.*/i.test(f) || /^(https?:|ftps?:|file:|)\/\//i.test(f) || l.test(f) || ["/", "{", "[", "#", "("].indexOf((f || "")[0]) < 0 && (f = b.opts.linkAutoPrefix + f), f = b.helpers.sanitizeURL(f), b.opts.linkAlwaysBlank && (h.target = "_blank"), b.opts.linkAlwaysNoFollow && (h.rel = "nofollow"), "_blank" == h.target ? h.rel ? h.rel += " noopener noreferrer": h.rel = "noopener noreferrer": null == h.target && (h.rel ? h.rel = h.rel.replace(/noopener/, "").replace(/noreferrer/, "") : h.rel = null), g = g || "", f === b.opts.linkAutoPrefix) {
                var m = b.popups.get("link.insert");
                return m.find('input[name="href"]').addClass("fr-error"),
            ...
            if (o) n = a(o),
            n.attr("href", f),
            g.length > 0 && n.text() != g && !i && n.text(g),
            i || n.prepend(a.FE.START_MARKER).append(a.FE.END_MARKER),
            n.attr(h),
            i || b.selection.restore();
                ...
                for (var p = d(), r = 0; r < p.length; r++) n = a(p[r]),
                n.attr(h),
                n.removeAttr("_moz_dirty");
        ...
        function g(e) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                i.after(c("LI"));
                    ...
                    b.helpers.getPX(a(j).css(m)) && (l += ' style="' + m + ":" + b.helpers.getPX(a(j).css(m)) + 'px;"'),
    ...
    a.FE.URLRegEx = "(^| |\\u00A0)(" + a.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}))$",
    a.FE.PLUGINS.url = function(b) {
        function c(c, d, e) {
            for (var f = ""; e.length && "." == e[e.length - 1];) f += ".",
            e = e.substring(0, e.length - 1);
            var g = e;
            if (b.opts.linkConvertEmailAddress) {
                var h = a.FE.MAIL_REGEX;
                h.test(g) && !/^mailto:.*/i.test(g) && (g = "mailto:" + g)
            }
            return /^((http|https|ftp|ftps|mailto|tel|sms|notes|data)\:)/i.test(g) || (g = "//" + g),
            (d ? d: "") + "<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"': "") + (j ? ' rel="' + j + '"': "") + ' href="' + g + '">' + e.replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</a>" + f
        }
        function d() {
    ...
    a.FE.PLUGINS.video = function(b) {
        ...
        function R() {
            ...
            b.events.on("blur video.hideResizer commands.undo commands.redo element.dropped",
            function() {
                K(!0)
            })
        }
