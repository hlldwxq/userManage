...
<div class="jumbotron" style="margin-top:50px">
    <div class="container">
        <h2 style="font-family: 微软雅黑">创建新条目</h2>
    </div>
</div>
<div class="content">
<div class="row">
    ...
    <div class="col-xs-8">
        <form class="form-horizontal" name="form1" method="post" action="./save" enctype="multipart/form-data" onsubmit="return improveSubmit()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input class="input-file" id="m_movup" type="file" name="pic">
                </div>
            </div>
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label">内容</label>
                <div class="col-sm-6">
                    <textarea id="content" class="form-control" rows="5" name="brief"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="source" class="col-sm-2 control-label">出现此桥段的作品</label>
                <div class="col-sm-6">
                    <textarea id="source" class="form-control" rows="3" placeholder="请按“作品名：简介”的格式提交，如果有多部作品，请用回车分隔" name="sourcename"></textarea>
                </div>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-4">
                    <button type="submit" class="btn btn-default" name="actiontype" value="0">提交</button>
                </div>
            </div>
        </form>
    </div>
