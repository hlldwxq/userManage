...
<div class="container" style="margin-top: 20px">
    ...
    <form class="form-horizontal" role="form"  action="${pageContext.request.contextPath}/movie/invest-result" method="post" id="m_movinvest_form" name="form_1"  autocomplete="off">
        ...
        <div class="form-group">
            <div class="col-sm-offset-6 col-sm-6">
                <button type="submit" class="btn"><a href="invest-result.html">提交生成分析报告</a></button>
            </div>
        </div>
    </form>
</div>
