...
<div class="container" style="margin-top: 20px">
    ...
    <div class="row featurette" >
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="m_movrelated_result" class="col-sm-4 control-label">电视剧周边</label>
                <div class="col-sm-8">
        ...
        <div class="row featurette">
            ...
            <div class="control-group row">
                ...
                <div class="controls col-sm-6">
                    ...
                    <label class="checkbox-inline">
                        <input value="偶像" type="checkbox">偶像
                    </label>
                    <label class="checkbox-inline">
                        <input value="古装" type="checkbox">古装
                    </label>
                    <label class="checkbox-inline">
                        <input value="喜剧" type="checkbox">喜剧
                    </label>
                    <label class="checkbox-inline">
