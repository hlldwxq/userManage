...
<div class="container" style="margin-top: 20px">
    ...
    <form class="form-horizontal" role="form"  action="#" id="m_movinvest_up" name="form_1" method="#" autocomplete="off">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input class="input-file" id="m_movup" type="file" accept="application/msword,text/plain">
            </div>
        </div>
        <div class="form-group">
            <label for="m_movdirector" class="col-sm-4 control-label">筛选题材</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="m_movdirector" placeholder="请输入需要的题材">
            </div>
        </div>
        <div class="form-group">
