...
<div class="container" style="margin-top: 20px">
    ...
    <form class="form-horizontal" role="form"  action="#" id="m_movinvest_up" name="form_1" method="#" autocomplete="off">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="m_movmaincast_f" value="${result.starring}">
            </div>
        </div>
        <div class="form-group">
            <label for="m_movdirector_r" class="col-sm-4 control-label">导演</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="m_movdirector_r"  value="${result.director}">
            </div>
        </div>
        <div class="form-group">
            <label for="m_movmake_r" class="col-sm-4 control-label">制作团队</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="m_movmake_r"  value="${result.team}">
            </div>
        </div>
        <div class="form-group">
            <label for="m_moveffect_r" class="col-sm-4 control-label">特效公司</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="m_moveffect_r"  value="${result.effectCompany}">
            </div>
        </div>
