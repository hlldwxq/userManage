...
<div class="jumbotron" style="margin-top: 40px;">
    <div class="container">
        ...
        <p>通过热点话题、节目特点等数据，为您推荐嘉宾和主题。海量标签匹配，预测收视率，为您提供最优选择。</p>
    </div>
</div>
...
<div class="container">
    ...
    <div class="col-md-5 col-md-offset-1">
        ...
        <ol>
            <li class="lead"><%=(String) session.getAttribute("name")%></li><%} %>
    ...
    <div class="col-md-5 col-md-offset-1">
        ...
        <div class="col-md-3 col-md-offset-4">
            <div class="btn btn-primary btn-sm active" role="button"><a href="${pageContext.request.contextPath}/entertainment/guest_theme_recommend?comment=2">不感兴趣？换一批试试～～</a>></div>
        </div>
    </div>
</div>
...
<div class="container">
	...
	<div class="col-md-10 col-md-offset-2">
			<div class="col-md-3 grid">
                <h3>舒淇</h3>
                <a href="#"><img class="img-responsive" src="/image/舒淇.jpg"></a>
                <p>代表作品：《刺客聂隐娘》《非诚勿扰》</p>
            </div>
            <div class="col-md-3 grid">
                <h3>冯远征</h3>
                <a href="#"><img class="img-responsive" src="image/冯远征.jpg"></a>
                <p>代表作品：《不要和陌生人说话》</p>
            </div>
            <div class="col-md-3 grid">
                <h3>周杰伦</h3>
                <a href="variety%20show_2_change.htmlml"><img class="img-responsive" src="image/周杰伦.jpg"></a>
                <p>代表作品：《不能说的秘密》</p>
            </div>
	</div>
